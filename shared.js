...
const TOOL_CAT={merge:'org',split:'org',delete:'org',organize:'org',extract:'org',compress:'opt',repair:'opt',img2pdf:'conv',pdf2jpg:'conv',rotate:'edit',watermark:'edit',sign:'edit',crop:'edit',pagenums:'edit',security:'sec'};
  ...
  en:{
    ...
    faqs:[
      ...
      {q:"Can I use iWorkPDF without creating an account?",
       a:"Yes, completely. All 15 tools work without any account. The account is only needed if you want to save a cloud link for 48h sharing. You can ignore it entirely."},
  ...
  fr:{
    ...
    faqs:[
      ...
      {q:"Puis-je utiliser iWorkPDF sans creer de compte ?",
       a:"Oui, completement. Les 15 outils fonctionnent sans compte. Le compte est necessaire uniquement si vous voulez sauvegarder un lien cloud de partage 48h. Vous pouvez totalement ignorer cette option."},
...
// 4 outils mis en avant + menu déroulant « Tous les outils PDF » (15 outils).
...
// bouton). Générique : s'applique aux 15 outils sans éditer leurs pages.
