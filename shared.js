...
const T={
  en:{illu_pc:'Your computer',illu_local:'Local processing',illu_dl:'Download',illu_nosrv:'No server',demo_drop:'Drop a PDF here to try',demo_pick:'Now pick a tool for your PDF 👇',why:'Why iWorkPDF?',cmp:'iWorkPDF vs other tools',badge:'Privacy-first',h1:'All your PDF tools,',h2:'in your browser.',sub:'iWorkPDF — free online PDF tools, all processed locally in your browser.',cta1:'Choose a tool',cta2:'Create account',hproof:'✓ {N} tools · ✓ 100% local · ✓ No install · ✓ Free forever',hoss:'Open-source engine · pdf-lib · PDF.js',sb1:'Encrypted in transit',sb2:'Signed URLs (1h)',sb3:'Auto-delete 48h',sb4:'Audit logs',sb5:'RLS isolation',st1:'PDF Tools',st2:'Local by default',st3:'Cloud: auto-deleted 48h',st4:'Files processed',ttl:'What do you want to do?',tsub:'Click a tool to get started',signin:'Sign in',register:'Register',logout:'Sign out',myacc:'My account',myfiles:'My files',actlog:'Activity log',histtitle:'My account',vfy:'Check your email to activate your account.',logininfo:'Your credentials are encrypted and never stored in plain text.',reginfo:'A confirmation email will be sent. Your account will be active after verification.',firstname:'First name',password:'Password',pwdmin:'Password (8 chars min.)',confirmpwd:'Confirm password',loading:'Loading…',nofiles:'No shared files',noactivity:'No activity yet',expiresin:'Expires in',deleteon:'File deleted on',linkvalid:'Link valid until',signedlink:'Secure link (valid 1h):',copylink:'Copy',linkcopied:'Link copied!',localmode:'Local',savemode:'Save file',cloudsub:'Saved 48h in your account',footer:'100% local processing · Signed URLs · Audit logs',merge:'Merge PDFs',delete:'Delete pages',split:'Split PDF',organize:'Organize',ocr:'OCR PDF',rotate:'Rotate',compress:'Compress',security:'Security',watermark:'Watermark',img2pdf:'Images → PDF',dmerge:'Combine multiple PDFs',ddelete:'Remove specific pages',dsplit:'Export each page as PDF',dorganize:'Reorder, rotate & remove pages',docr:'Make scanned PDFs searchable',drotate:'Rotate pages 90°, 180°…',dcompress:'Reduce PDF file size',dsecurity:'Protect or unlock a PDF',dwatermark:'Add diagonal watermark',dimg2pdf:'Convert JPG/PNG to PDF',drop:'Drag your PDFs here',dropimg:'Drag your images here',browse:'or click to browse',max:'Max 50 MB per file',pagesdel:'Pages to delete (e.g. 1,3,5-8):',pwdlbl:'Password:',wmlbl:'Watermark text:',angle:'Angle:',dest:'Destination:',direct:'Direct download',merge_btn:'🔀 Merge',org_btn:'🗂 Organize',del_btn:'🗑 Delete',split_btn:'✂️ Split',rot_btn:'🔄 Apply',comp_btn:'🗜 Compress',comp_quality:'Compression level',comp_low:'⚡ Max compression',comp_med:'✅ Recommended',comp_high:'💎 Light',comp_scanning:'Analyzing PDF…',comp_est_title:'Estimate before compressing',comp_est_max:'Max possible',comp_est_rec:'Recommended (quality kept)',comp_est_images:'images detected',comp_est_none:'No compressible images found — gain will be limited.',comp_optimizing:'Recompressing images…',sec_btn:'Apply',wm_btn:'💧 Apply',img_btn:'🖼 Convert',protect:'🔒 Protect',unlock:'🔓 Unlock',processing:'Processing…',reading:'Reading…',done:'Done! File downloaded.',uploading:'Secure upload…',uploaded:'File uploaded successfully.',splitinfo:'Each page will be downloaded separately.',secnote:'🔒 Real AES-256 encryption — runs 100% in your browser.',nofile:'Please add a file.',nopages:'Enter page numbers.',nopwd:'Enter a password.',nowm:'Enter watermark text.',alldeleted:'Cannot delete all pages.',signedin:'Signing in…',creatingacc:'Creating account…',accreated:'✅ Account created! Check your email to activate it.',download:'⬇ Download',
    sign:'Sign PDF',dsign:'Add handwritten signature to PDF',extract:'Extract Images',dextract:'Extract embedded photos at original resolution',metadata:'PDF Metadata',dmetadata:'See and erase hidden document data',meta_title:'Title',meta_author:'Author',meta_subject:'Subject',meta_keywords:'Keywords (comma separated)',meta_creator:'Creator (software)',meta_producer:'Producer',meta_created:'Created',meta_modified:'Modified',meta_mode_edit:'✏️ Edit',meta_mode_strip:'🧹 Erase everything',meta_btn:'🏷 Apply',meta_found:'This PDF currently reveals:',meta_none:'This PDF contains no identifying metadata.',meta_hint:'Leave a field empty to remove it from the document.',meta_strip_note:'Every metadata entry is removed from the document — title, author, software and both dates. Nothing is blanked or normalised: the entries no longer exist. The page content itself is left untouched.',meta_unreadable:'This PDF cannot be read (it may be password protected).',pages:'Extract Pages',dpages:'Keep only the pages you pick',pages_lbl:'Pages to extract (e.g. 1,3,5-8):',pages_hint:'Use commas for single pages and a dash for ranges.',pages_btn:'📑 Extract',pages_total:'pages in this document',pages_selected:'pages will be extracted',
  ...
  fr:{illu_pc:'Votre ordinateur',illu_local:'Traitement local',illu_dl:'Téléchargement',illu_nosrv:'Aucun serveur',demo_drop:'Déposez un PDF ici pour essayer',demo_pick:'Choisissez maintenant un outil pour votre PDF 👇',why:'Pourquoi iWorkPDF ?',cmp:'iWorkPDF face aux autres',badge:'Privacy-first',h1:'Tous vos outils PDF,',h2:'dans votre navigateur.',sub:'iWorkPDF — outils PDF gratuits, tout est traité localement dans votre navigateur.',cta1:'Choisir un outil',cta2:'Créer un compte',hproof:'✓ {N} outils · ✓ 100% local · ✓ Sans installation · ✓ Gratuit à vie',hoss:'Moteur open-source · pdf-lib · PDF.js',sb1:'Chiffrement en transit',sb2:'URLs signées (1h)',sb3:'Suppression auto 48h',sb4:'Audit logs',sb5:'Isolation RLS',st1:'Outils PDF',st2:'Local par défaut',st3:'Cloud: supprimé après 48h',st4:'Fichiers traités',ttl:'Que voulez-vous faire ?',tsub:'Cliquez sur un outil pour commencer',signin:'Connexion',register:'Inscription',logout:'Se déconnecter',myacc:'Mon compte',myfiles:'Mes fichiers',actlog:"Journal d'activité",histtitle:'Mon compte',vfy:'Vérifiez votre email pour activer votre compte.',logininfo:'Vos identifiants sont chiffrés et jamais stockés en clair.',reginfo:'Un email de confirmation vous sera envoyé. Votre compte sera actif après vérification.',firstname:'Prénom',password:'Mot de passe',pwdmin:'Mot de passe (8 car. min.)',confirmpwd:'Confirmer le mot de passe',loading:'Chargement…',nofiles:'Aucun fichier partagé',noactivity:'Aucune activité',expiresin:'Expire dans',deleteon:'Fichier supprimé le',linkvalid:"Lien valide jusqu'à",signedlink:'Lien sécurisé (valide 1h) :',copylink:'Copier',linkcopied:'Lien copié !',localmode:'Local',savemode:'Sauvegarder',cloudsub:'Enregistré 48h dans votre compte',footer:'Traitement 100% local · URLs signées · Audit logs',merge:'Fusionner',delete:'Supprimer pages',split:'Diviser',organize:'Organiser',ocr:'OCR PDF',rotate:'Rotation',compress:'Compresser',security:'Sécurité',watermark:'Filigrane',img2pdf:'Images → PDF',dmerge:'Combinez plusieurs PDFs',ddelete:'Supprimez des pages précises',dsplit:'Exportez chaque page en PDF',dorganize:'Réordonnez, pivotez et retirez des pages',docr:'Rendez vos scans cherchables',drotate:'Pivotez les pages à 90°, 180°…',dcompress:'Réduisez la taille du PDF',dsecurity:'Protégez ou déverrouillez un PDF',dwatermark:'Ajoutez un filigrane diagonal',dimg2pdf:'Convertissez JPG/PNG en PDF',drop:'Glissez vos PDFs ici',dropimg:'Glissez vos images ici',browse:'ou cliquez pour parcourir',max:'Max 50 Mo par fichier',pagesdel:'Pages à supprimer (ex: 1,3,5-8) :',pwdlbl:'Mot de passe :',wmlbl:'Texte du filigrane :',angle:'Angle :',dest:'Destination :',direct:'Téléchargement direct',merge_btn:'🔀 Fusionner',org_btn:'🗂 Organiser',del_btn:'🗑 Supprimer',split_btn:'✂️ Diviser',rot_btn:'🔄 Appliquer',comp_btn:'🗜 Compresser',comp_quality:'Niveau de compression',comp_low:'⚡ Compression max',comp_med:'✅ Recommandé',comp_high:'💎 Léger',comp_scanning:'Analyse du PDF…',comp_est_title:'Estimation avant compression',comp_est_max:'Maximum possible',comp_est_rec:'Recommandé (qualité préservée)',comp_est_images:'images détectées',comp_est_none:'Aucune image compressible détectée — le gain sera limité.',comp_optimizing:'Recompression des images…',sec_btn:'Appliquer',wm_btn:'💧 Appliquer',img_btn:'🖼 Convertir',protect:'🔒 Protéger',unlock:'🔓 Déverrouiller',processing:'Traitement…',reading:'Lecture…',done:'Terminé ! Fichier téléchargé.',uploading:'Upload sécurisé…',uploaded:'Fichier uploadé avec succès.',splitinfo:'Chaque page sera téléchargée séparément en local.',secnote:'🔒 Chiffrement AES-256 réel — 100% dans votre navigateur.',nofile:'Ajoutez un fichier.',nopages:'Entrez les numéros de pages.',nopwd:'Entrez un mot de passe.',nowm:'Entrez le texte du filigrane.',alldeleted:'Impossible de supprimer toutes les pages.',signedin:'Connexion…',creatingacc:'Création du compte…',accreated:'✅ Compte créé ! Vérifiez votre email pour l\'activer.',download:'⬇ Télécharger',
    sign:'Signer PDF',dsign:'Ajoutez une signature manuscrite au PDF',metadata:'Métadonnées PDF',dmetadata:'Voyez et effacez les données cachées',meta_title:'Titre',meta_author:'Auteur',meta_subject:'Sujet',meta_keywords:'Mots-clés (séparés par des virgules)',meta_creator:'Créateur (logiciel)',meta_producer:'Producteur',meta_created:'Créé le',meta_modified:'Modifié le',meta_mode_edit:'✏️ Modifier',meta_mode_strip:'🧹 Tout effacer',meta_btn:'🏷 Appliquer',meta_found:'Ce PDF révèle actuellement :',meta_none:'Ce PDF ne contient aucune métadonnée identifiante.',meta_hint:'Laissez un champ vide pour le retirer du document.',meta_strip_note:'Toutes les métadonnées sont retirées du document — titre, auteur, logiciel et les deux dates. Rien n’est vidé ni normalisé : les entrées n’existent plus. Le contenu des pages n’est pas modifié.',meta_unreadable:'Ce PDF est illisible (il est peut-être protégé par mot de passe).',pages:'Extraire des pages',dpages:'Ne gardez que les pages choisies',pages_lbl:'Pages a extraire (ex: 1,3,5-8) :',pages_hint:'Virgule pour des pages seules, tiret pour un intervalle.',pages_btn:'📑 Extraire',pages_total:'pages dans ce document',pages_selected:'pages seront extraites',extract:'Extraire Images',dextract:'Extrait les photos intégrées en résolution d\'origine',
...
const TOOLS=[
  ...
  {id:'organize', icon:'🗂',nk:'organize', dk:'dorganize', migrated:true},
  ...
  {id:'ocr',      icon:'🔎',nk:'ocr',      dk:'docr', migrated:true},
  ...
  {id:'metadata', icon:'🏷',nk:'metadata',dk:'dmetadata', migrated:true},
];
...
// → plus jamais besoin de rebumper un nombre en dur en ajoutant un outil.
...
const TOOL_CAT={merge:'org',split:'org',delete:'org',organize:'org',extract:'org',pages:'org',metadata:'sec',compress:'opt',repair:'opt',img2pdf:'conv',pdf2jpg:'conv',ocr:'conv',rotate:'edit',watermark:'edit',sign:'edit',crop:'edit',pagenums:'edit',security:'sec'};
...
const TOOL_ICONS={
  ...
  // Une icône ABSENTE ici ne dégrade pas seulement l'esthétique : toolIconHTML()
  // retombe sur un <span> emoji sans la classe .tic (flex-shrink:0, dimensions
  // fixes), et la description de la carte s'effondre à la largeur de l'emoji.
  pages:'<rect x="5" y="8" width="12" height="16" rx="2.2" fill="currentColor" fill-opacity=".3"/><rect x="15" y="11" width="12" height="16" rx="2.2" fill="currentColor"/><path d="M18.2 19h5.6M21 16.2l2.8 2.8L21 21.8" stroke="var(--sf)" stroke-width="1.5"/>',
  metadata:'<path d="M5 6.8A1.8 1.8 0 0 1 6.8 5h8a2 2 0 0 1 1.4.6l9 9a2 2 0 0 1 0 2.8l-8 8a2 2 0 0 1-2.8 0l-9-9A2 2 0 0 1 5 15z" fill="currentColor"/><circle cx="10.6" cy="10.6" r="2.1" fill="var(--sf)"/>',
  ...
  organize:'<rect x="5" y="5" width="9" height="10" rx="1.8" fill="currentColor"/><rect x="18" y="5" width="9" height="10" rx="1.8" fill="currentColor" fill-opacity=".3"/><rect x="5" y="17" width="9" height="10" rx="1.8" fill="currentColor" fill-opacity=".3"/><rect x="18" y="17" width="9" height="10" rx="1.8" fill="currentColor"/>',
  ...
  ocr:'<rect x="6" y="4" width="18" height="24" rx="2.5" fill="currentColor"/><path d="M10 10h10M10 14h10M10 18h6" stroke="var(--sf)" stroke-width="1.6"/><circle cx="19.5" cy="20.5" r="3.6" fill="none" stroke="var(--sf)" stroke-width="1.7"/><path d="M22.1 23.1l2.4 2.4" stroke="var(--sf)" stroke-width="1.8"/>',
...
function toolIconHTML(id,px){
  ...
  const size=px||44;
  // Repli emoji : il DOIT porter .tic et des dimensions fixes, sinon la carte
  // perd son flex-shrink:0 et la description se réduit à la largeur de l'emoji
  // (une ligne par mot). Un outil sans icône reste ainsi seulement moins joli.
  if(!g){
    const e=(TOOLS.find(t=>t.id===id)||{}).icon||'';
    return `<span class="tic" aria-hidden="true" style="width:${size}px;height:${size}px;font-size:${Math.round(size*0.6)}px">${e}</span>`;
  }
...
const TRUST_I18N = {
  en:{
    ...
    sb1:"Your files stay on your device by default", sb2:"No account required",
    ...
    pr2:"No silent upload", pr2s:"Nothing leaves your device unless you choose it",
    ...
    faqs:[
      {q:"Do my files get uploaded to your servers?",
       a:"By default, every PDF operation runs entirely in your browser using pdf-lib.js, and your file is not sent anywhere. The only exceptions are features you explicitly choose — such as Cloud 48h sharing — and they always tell you before anything is sent. The network monitor at the bottom of the page lists every request the page makes, so you can check for yourself."},
  ...
  fr:{
    ...
    sb1:"Vos fichiers restent sur votre appareil par defaut", sb2:"Sans compte requis",
    ...
    pr2:"Aucun envoi silencieux", pr2s:"Rien ne quitte votre appareil sans votre choix explicite",
    ...
    faqs:[
      {q:"Mes fichiers sont-ils envoyes sur vos serveurs ?",
       a:"Par defaut, chaque operation PDF fonctionne entierement dans votre navigateur via pdf-lib.js, et votre fichier n’est envoye nulle part. Les seules exceptions sont les fonctions que vous choisissez explicitement — comme le partage Cloud 48h — et elles vous previennent toujours avant tout envoi. Le moniteur reseau en bas de page liste chaque requete effectuee : vous pouvez le verifier vous-meme."},
...
function t(k){
  let s=(T[lang]||T.en)[k]||k;
  if(typeof s==='string'&&s.indexOf('{')!==-1){
    s=s.replace(/\{N3\}/g,TOOL_COUNT-3).replace(/\{N\}/g,TOOL_COUNT);
  }
  return s;
}
...
// 4 outils mis en avant + menu déroulant « Tous les outils PDF » (tous les outils).
...
// La langue des pages outils est portée par l'URL (/tools/merge en anglais,
// /fr/outils/fusionner-pdf en français), et non par un simple état JS : c'est
// ce qui permet à Google d'indexer une vraie page par langue. Le sélecteur doit
// donc NAVIGUER, sinon les pages françaises resteraient introuvables depuis l'UI.
const TOOL_FR_SLUG={merge:'fusionner-pdf',delete:'supprimer-pages-pdf',split:'diviser-pdf',
  ...
  sign:'signer-pdf',crop:'rogner-pdf',repair:'reparer-pdf',extract:'extraire-images-pdf',pages:'extraire-pages-pdf',metadata:'metadonnees-pdf'};
...
function langCounterpartUrl(target){
  ...
  let m=p.match(/^\/tools\/([a-z0-9]+)(?:\.html)?$/);
  if(m && target==='fr' && TOOL_FR_SLUG[m[1]]) return '/fr/outils/'+TOOL_FR_SLUG[m[1]];
  m=p.match(/^\/fr\/outils\/([a-z0-9-]+)(?:\.html)?$/);
  if(m && target==='en'){
    const id=Object.keys(TOOL_FR_SLUG).find(k=>TOOL_FR_SLUG[k]===m[1]);
    if(id) return '/tools/'+id;
  }
  return null; // pas de contrepartie (accueil, blog…) → bascule JS habituelle
}

function setLang(l){
  const alt=langCounterpartUrl(l);
...
function renderAccountPane(){
  ...
  chg.className='btn-ghost full';
  chg.style.cssText='margin-bottom:8px';
  chg.textContent=fr?'🔑 Changer mon mot de passe':'🔑 Change my password';
  chg.addEventListener('click',openNewPasswordModal);
  el.appendChild(chg);
...
async function loadFiles(){
  ...
  data.forEach(f=>{
    ...
    item.querySelector('.btn-share').addEventListener('click',()=>shareFile(f.id,f.filename,f.expires_at));
...
async function shareFile(fileId, filename, expiresAt){
  try{
    // Lien BRANDÉ vers une page de téléchargement (le destinataire reste sur
    // iWorkPDF, voit le nom du fichier + l'expiration). Le fichier n'est servi
    // que via une URL signée courte générée à la volée par la page.
    const link = location.origin + '/download?id=' + encodeURIComponent(fileId);
    const h = Math.max(0, Math.round((new Date(expiresAt).getTime() - Date.now())/3600000));
    let copied=false;
    try{ await navigator.clipboard.writeText(link); copied=true; }catch(_){}
    if(copied){
      showToast((lang==='fr'?'🔗 Lien de partage copié — valable ~':'🔗 Share link copied — valid ~')+h+'h', 'ok');
    }else{
      prompt(lang==='fr'?'Lien de partage (valable ~'+h+'h) :':'Share link (valid ~'+h+'h):', link);
    }
    try{ await audit('share', fileId, {filename}); }catch(_){}
...
function buildUI(id){
  ...
  switch(id){
    ...
    case 'organize': body=typeof buildOrganizeUI==='function'?buildOrganizeUI():''; break;
    ...
    case 'ocr': body=typeof buildOcrUI==='function'?buildOcrUI():''; break;
    ...
    case 'metadata': body=typeof buildMetadataUI==='function'?buildMetadataUI():''; break;
  }
...
function setRbn(gid,btn,val,type){
  ...
  else if(type==='ocrlang')ocrLang=val;
}
...
// bouton). Générique : s'applique à tous les outils sans éditer leurs pages.
...
async function handleFiles(files,id){
  ...
  const type = (id==='img2pdf') ? 'image' : (id==='pagenums'||id==='repair'||id==='ocr') ? 'any' : 'pdf';
  ...
  for(const f of files){
    try{
      if(type!=='any') await Security.validateFile(f,type);
        ...
        if(id==='ocr' && !['pdf','jpg','jpeg','png','webp'].includes(ext))
          throw new Error(`Unsupported file: ${f.name}. Use PDF or an image (JPG/PNG).`);
  ...
  else if(id==='organize') await renderOrganizePreview();
  ...
  else if(id==='metadata'){renderFiles();await renderMetaPanel();}
  else renderFiles();
  syncHasFiles();
}
...
function injectJsonLd(toolId, titleEn, descEn){
  ...
  if(!tool) return;
  // L'URL vient du <link rel="canonical"> de la page : sur une page française
  // (/fr/outils/…), fabriquer l'URL anglaise enverrait à Google des données
  // structurées contredisant sa propre canonique.
  const url = document.querySelector('link[rel=canonical]')?.href
           || `https://iworkpdf.yendyx.com/tools/${toolId}`;
  const data = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "description": descEn,
        "featureList": [
          "Local processing by default — nothing is uploaded unless you choose it",
          "No account required",
          "Free forever",
...
async function run(id){
  ...
  try{
    if(id==='merge'){
      ...
      const r=await runMetadata(activeFiles);
      if(!r)return;
      result=r.result; filename=r.filename;
    }
    else if(id==='organize'){
      const r=await runOrganize(activeFiles, typeof organizePages!=='undefined'?organizePages:[]);
      if(!r)return; // earlyReturn déjà géré dans runOrganize
      result=r.result; filename=r.filename;
    }
    else if(id==='split'){
      ...
      await runOcr(activeFiles, typeof ocrLang!=='undefined'?ocrLang:'eng+fra');
      return;
    }
