  ...
  en:{
    ...
    faqs:[
      ...
      {q:"Can I use iWorkPDF without creating an account?",
       a:"Yes, completely. All 16 tools work without any account. The account is only needed if you want to save a cloud link for 48h sharing. You can ignore it entirely."},
  ...
  fr:{
    ...
    faqs:[
      ...
      {q:"Puis-je utiliser iWorkPDF sans creer de compte ?",
       a:"Oui, completement. Les 16 outils fonctionnent sans compte. Le compte est necessaire uniquement si vous voulez sauvegarder un lien cloud de partage 48h. Vous pouvez totalement ignorer cette option."},
...
// 4 outils mis en avant + menu déroulant « Tous les outils PDF » (16 outils).
...
// bouton). Générique : s'applique aux 16 outils sans éditer leurs pages.
